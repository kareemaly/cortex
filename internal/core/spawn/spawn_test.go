...
func (m *mockTmuxManager) SpawnAgent(session, windowName, agentCommand string) (int, error) {
	if m.spawnErr != nil {
		return 0, m.spawnErr
	}
	m.spawnCalls++
...
func (m *mockTmuxManager) SpawnArchitect(session, windowName, agentCommand string) error {
	if m.spawnErr != nil {
		return m.spawnErr
	}
	m.spawnCalls++
